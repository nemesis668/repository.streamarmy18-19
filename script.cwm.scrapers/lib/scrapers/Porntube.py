...
Base_Domain = 'https://www.porntube.com'
SiteName = 'Porntube'
...
class Scraper:
    def __init__(self):
        self.Base = 'https://www.porntube.com/videos?p=1'
        self.CatUrl = 'https://www.porntube.com/tags'
        self.Search = ('https://www.porntube.com/search?q=%s')
        self.content = []
        self.links = []
        self.cats = []
        ...
        try:
            ...
            for i in data:
                try:
                    ...
                    url1 = i['slug']
                    url2 = i['uuid']
                    finalurl = ('https://www.porntube.com/videos/%s_%s' % (url1,url2))
    ...
    def ResolveLink(self,url):
        ...
        if qualtype == 'SD': posturl = 'https://token.porntube.com/%s/desktop/480+360+240' % mediaid
        else: posturl = 'https://token.porntube.com/%s/desktop/720+480+360+240' % mediaid
    ...
    def GetNextPage(self,url):
        if url == '':
            url = 'https://www.porntube.com/videos?p=2'
            return url
        else:
            if not '/tags/' in url:
                getcurrent = re.findall(r'\d+',url)[0]
                NewNextPageUrl = int(getcurrent) + 1
                NextPageUrl = ('https://www.porntube.com/videos?p=%s' % NewNextPageUrl)
                return NextPageUrl
            else:
