...
headers = {'User-Agent' : 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.82',
		   'Referer' : 'https://www.fux.com/',
		   'Origin' : 'https://www.fux.com/'}
Base_Domain = 'https://www.fux.com'
SiteName = 'Fux'
...
class Scraper:
    def __init__(self):
        self.Base = 'https://www.fux.com/videos?p=1'
        self.CatUrl = 'https://www.fux.com/tags'
        self.Search = ('https://www.fux.com/search?q=%s')
        self.content = []
        self.links = []
        self.cats = []
        ...
        try:
            ...
            for i in data:
                try:
                    ...
                    url1 = i['slug']
                    url2 = i['uuid']
                    finalurl = ('https://www.fux.com/videos/%s_%s' % (url1,url2))
    ...
    def ResolveLink(self,url):
        ...
        if qualtype == 'SD': posturl = 'https://token.fux.com/%s/desktop/480+360+240' % mediaid
        else: posturl = 'https://token.fux.com/%s/desktop/720+480+360+240' % mediaid
    ...
    def GetNextPage(self,url):
        if url == '':
            url = 'https://www.fux.com/videos?p=2'
            return url
        else:
            if not '/tags/' in url:
                getcurrent = re.findall(r'\d+',url)[0]
                NewNextPageUrl = int(getcurrent) + 1
                NextPageUrl = ('https://www.fux.com/videos?p=%s' % NewNextPageUrl)
                return NextPageUrl
            else:
